...
- **Python**: Scripting, data analysis, ML workflows  
- **Machine Learning**: Predictive modeling (Regression, Trees, basics of Neural Networks)  
- **Data Science**: EDA, visualization, preprocessing  
